...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/BNRCoreDataStackConvenienceUpdates"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Dariusz Rybicki" => "darrarski@gmail.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/BNRCoreDataStackConvenienceUpdates.git", :tag => s.version.to_s }
  ...
  s.resource_bundles = {
    'BNRCoreDataStackConvenienceUpdates' => ['Pod/Assets/*.png']
  }
